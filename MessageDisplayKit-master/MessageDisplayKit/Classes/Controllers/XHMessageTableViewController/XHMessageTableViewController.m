...
//            CGSize beforeContentSize = self.messageTableView.contentSize;
//            weakSelf.messages = messages;
//            [self.messageTableView reloadData];
//            CGSize afterContentSize = self.messageTableView.contentSize;
//
//            CGPoint afterContentOffset = self.messageTableView.contentOffset;
//            CGPoint newContentOffset = CGPointMake(afterContentOffset.x, afterContentOffset.y + afterContentSize.height - beforeContentSize.height);
//            self.messageTableView.contentOffset = newContentOffset;
