...
- (void)setupMessageInputViewBarWithStyle:(XHMessageInputViewStyle)style {
    ...
    if (!placeHolder) {
        placeHolder = NSLocalizedStringFromTable(@"发送新消息", @"MessageDisplayKitString", nil);
    }
    ...
    if (self.allowsSendVoice) {
        ...
        [button setTitle:NSLocalizedStringFromTable(@"放开发送", @"MessageDisplayKitString", nil)  forState:UIControlStateHighlighted];
